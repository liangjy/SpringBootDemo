...
(function () {
    ...
    TextIconOverlay.prototype._updatePosition = function(){
        if (this._domElement && this._position) {
            ...
            if(this._styles[this._text]){
                if(this._styles[this._text]["offsetSize"] instanceof BMap.Size){
                    style.left = (pixelPosition.x + this._styles[this._text]["offsetSize"].x) + "px";
                    style.top = (pixelPosition.y + this._styles[this._text]["offsetSize"].y) + "px";
                }
            }else{
                if(this._styles[0]){
                    if(this._styles[0]["offsetSize"] instanceof BMap.Size){
                        style.left = (pixelPosition.x + this._styles[0]["offsetSize"].width) + "px";
                        style.top = (pixelPosition.y + this._styles[0]["offsetSize"].height) + "px";
                    }
                }else{
