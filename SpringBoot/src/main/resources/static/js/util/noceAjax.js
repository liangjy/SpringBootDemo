...
//            	}
//            	过滤空数据
//            	if((typeof(data)!="undefined"&&data.result.length<1)||
//            			(typeof(data.result)!="undefined"&&data.result.length<1)||
//            	  (typeof(data[0].result)!="undefined"&&data[0].result.length<1)){
//            		noce.noDataMsg();
//            	}else{
...
//            		超时返回登陆页面
            		...
            		//if(infor.indexOf("Not Found")>-1){
            			location.href = "pages_index_Index_login.action";
            			return false;
//            			status
